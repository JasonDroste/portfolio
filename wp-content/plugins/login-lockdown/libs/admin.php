...
class LoginLockdown_Admin extends LoginLockdown
{
  ...
  static function widget_content()
  {
    ...
    echo '</ul>';
    echo '<p>View the entire <a href="' . esc_url(admin_url('options-general.php?page=loginlockdown#loginlockdown_activity')) . '"> activity log</a> in the Login Lockdown plugin or change the <a href="' . esc_url(admin_url('options-general.php?page=loginlockdown#loginlockdown_login_form')) . '">login form protection settings.</p>';
  } // widget_content
