...
class LoginLockdown_Functions extends LoginLockdown
{
  ...
  static function login_form_fields()
  {
    ...
    if ($options['captcha'] == 'builtin') {
      ...
      echo '<img class="loginlockdown-captcha-img" style="vertical-align: text-top;" src="' . esc_url(LOGINLOCKDOWN_PLUGIN_URL) . '/libs/captcha.php?loginlockdown-generate-image=true&color=' . esc_attr(urlencode('#FFFFFF')) . '&noise=1&rnd=' . esc_attr(rand(0, 10000)) . '" alt="Captcha" />';
